...
fig_2.add_trace(
go.Scatter(x = df_dual_axis['date'], y = df_dual_axis['bike_rides_daily'], name = 'Daily bike rides', marker={'color': df_dual_axis['bike_rides_daily'],'color':'blue'}),
secondary_y = False
)

fig_2.add_trace(
go.Scatter(x=df_dual_axis['date'], y = df_dual_axis['avgTemp'], name = 'Daily temperature', marker={'color': df_dual_axis['bike_rides_daily'],'color':'red'}),
secondary_y=True
)
